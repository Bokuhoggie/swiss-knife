...
export const THEMES = {
  ...
  tron: {
    ...
    vars: {
      ...
      '--error':          '#FF2255',
      '--text-primary':   '#FFFFFF',
      '--text-secondary': '#6AACBB',
      '--text-muted':     '#152030',
      '--border':         'rgba(0, 212, 255, 0.09)',
      '--border-hover':   'rgba(0, 212, 255, 0.26)',
      '--shadow-card':    '0 0 0 1px rgba(0,212,255,0.06), 0 8px 40px rgba(0,0,0,0.97)',
      '--glow-accent':    '0 0 18px rgba(0,212,255,0.7)',
      '--glow-pink':      '0 0 18px rgba(255,255,255,0.55)',
      '--glow-cyan':      '0 0 18px rgba(0,85,255,0.65)',
    },
  },
